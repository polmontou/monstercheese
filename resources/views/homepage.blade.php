...
<body>
    <main>
        <div>
            <img src="./picture/plateauFromage.jpeg" alt="plateau de fromage">
        </div>
        <div>
            <h1>Nos produits phares</h1>
            <div>
                    <img src="./picture/pateDur.jpg" alt="Fromage pate dur">
                    <img src="./picture/pateDurePresse.jpg" alt="Fromage pate dur presse">
                    <img src="./picture/pateMolle.jpg" alt="Fromage pate molle">
            </div>
        </div>
    ...
    N       <p>Notre credo ?   <br>
        ...
        <div>
            ...
            <img src="./picture/pateDur.jpg" alt="">
        </div>
        <div>
            ...
            <div>
                ...
                <div>
                    <img src="./picture/pateDurePresse.jpg" alt="">
                    <h3>Fromage pâte pressée cuite</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pharetra maximus augue. Vivamus venenatis odio quis ligula consequat, et imperdiet nisl dignissim.</p>
                </div>
                <div>
                    <img src="./picture/pateMolle.jpg" alt="">
